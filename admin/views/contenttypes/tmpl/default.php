...
<form action="index.php?option=com_minitheatrecm&view=contenttypes" method="post" id="adminForm" name="adminForm" class="clearfix">
			...
			<thead>
				<tr>
					...
					<th width="67%" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'COM_MINITHEATRECM_MAINCOLUMN_CONTENTTYPE', 'a.name', $listDirn, $listOrder) ;?>
					</th>
			...
			<tbody>
				...
				<tr>
					...
					<td class="nowrap center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $row->state, $i, 'contenttypes.', true, 'cb', $row->publish_up, $row->publish_down); ?>
						</div>
					</td>
					<td>
						<div class="pull-left">
							<div>
								<?php echo NeonHtmlManager::renderMain($this->escape($row->name), $link, 'COM_MINITHEATRECM_TOOLTIP_EDIT_CONTENTTYPE')?>
							</div>
