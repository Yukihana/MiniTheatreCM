 ...
 * @since  0.0.1
 */
class MiniTheatreCMViewGenre extends JViewLegacy
{
	// Vars
	protected $form = null;
	...
	protected function addToolBar()
	{
		...
		$title = JText::_('COM_MINITHEATRECM_TITLE_GENRE').': '.JText::_($isNew ? 'COM_MINITHEATRECM_DICTIONARY_NEW' : 'COM_MINITHEATRECM_DICTIONARY_EDIT');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle(
			JText::_('COM_MINITHEATRECM_TITLE_GENRE').'::'.
