	...
	<?php endif; ?>
		...
		<table class="table table-striped table-hover">
			<thead>
				<tr>
					...
					<th width="20%" class="nowrap hidden-phone">
						<?php echo JHtml::_('searchtools.sort', $franchise_col->text, $franchise_col->order, $listDirn, $listOrder) ;?>
					</th>
			...
			<tbody>
				...
				<?php foreach ($this->items as $i => $row) : $link = JRoute::_('index.php?option=com_minitheatrecm&task=catalogue.edit&id=' . $row->id); ?>
				<tr>
					<td class="center">
					...
					<td class="small hidden-phone">
						<?php echo NeonHtmlManager::renderFranchiseCell($row->franchise_name, $row->franchise, $franchiselink, $franchise_col->index);?>
					</td>
