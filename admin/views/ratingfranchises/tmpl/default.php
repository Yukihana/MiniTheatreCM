	...
	<div id="j-main-container" class="span10">
		...
		<table class="table table-striped table-hover">
			<thead>
				<tr>
					...
					<th width="20%" class="nowrap">
						<?php echo JHtml::_('grid.sort', 'COM_MINITHEATRECM_DICTIONARY_FRANCHISE', 'target_id') ;?>
					</th>
					...
					<th width="7%" class="nowrap hidden-phone" style="text-align:right;">
			...
			<tbody>
				...
				<?php foreach ($this->items as $i => $row) : $link = JRoute::_('index.php?option=com_minitheatrecm&task=ratingfranchise.edit&id=' . $row->id); ?>
				<tr>
					<td class="center">
					...
					<td class="small nowrap">					
						<?php MiniTheatreCMLibHtmlManagerFields::getFranchise($this->franchises, $row->target_id);?>
					</td>
					<td class="small nowrap">					
