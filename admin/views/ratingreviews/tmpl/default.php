	...
	<div id="j-main-container" class="span10">
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				...
				<?php foreach ($this->items as $i => $row) : $link = JRoute::_('index.php?option=com_minitheatrecm&task=ratingreview.edit&id=' . $row->id); ?>
				<tr>
					<td class="center">
					...
					<td class="small nowrap">					
						<?php MiniTheatreCMLibHtmlManagerFields::getFranchise($this->itemnames, $row->target_id);?>
					</td>
					<td class="small nowrap">					
