...
<form action="index.php?option=com_minitheatrecm&view=genres" method="post" id="adminForm" name="adminForm" class="clearfix">
			...
			<thead>
				<tr>
					...
					<th width="67%" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'COM_MINITHEATRECM_MAINCOLUMN_GENRE', 'a.name', $listDirn, $listOrder) ;?>
					</th>
			...
			<tbody>
				...
				<tr>
					...
					<td class="nowrap center">
						<?php echo NeonHtmlManager::renderTaskButtons( $row->state, $i, 'genres.', true, $row->publish_up, $row->publish_down );?>
					</td>
					<td>
						<div class="pull-left">
							<div>
								<?php echo NeonHtmlManager::renderMain($this->escape($row->name), $link, 'COM_MINITHEATRECM_TOOLTIP_EDIT_GENRE')?>
							</div>
