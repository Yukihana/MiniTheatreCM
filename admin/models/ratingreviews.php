...
/**
 * RatingReviews Model-List
 *
 * @since  0.0.1
 */
class MiniTheatreCMModelRatingReviews extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select('*')->from($db->quoteName(MiniTheatreCMMetaConfig::getTableName('ratingreviews')));
		$db->setQuery($query);
	...
	{
		return MiniTheatreCMHelperModel::getItemnames( $this->getItems(), array('target_id') );
	}
}