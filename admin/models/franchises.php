 ...
 * @since  0.0.1
 */
class MiniTheatreCMModelFranchises extends NeonModelList
{
	...
	{
		// Query Config
		$this->dbtable				= 'franchises';
		$this->dbprefix				= 'a';
		
		// Query Vars: select, join
		$this->dbselect				= array('a.id', 'a.name', 'a.altnames', 'a.alias', 'a.genres', 'a.genres AS genre_json', 'a.access', 'a.state', 'a.publish_up', 'a.publish_down', 'a.author', 'a.recentedit', 'a.created', 'a.modified', 'a.hits', 'a.rating', 'a.votes');
