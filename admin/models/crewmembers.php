...
/**
 * Crew-Members Model-List
 *
 * @since  0.0.1
 */
class MiniTheatreCMModelCrewMembers extends NeonModelList
{
	...
	{
		// Query Config
		$this->dbtable				= 'crewmembers';
		$this->dbprefix				= 'a';
		
		// Query Vars: select, join
		$this->dbselect				= array('a.id', 'concat_ws(\' \', firstname, middlename, lastname) AS name', 'a.alias', 'a.access', 'a.state', 'a.publish_up', 'a.publish_down', 'a.author', 'a.recentedit', 'a.created', 'a.modified');
		...
		$this->dbfilters_search		= array('name', 'a.alias');
