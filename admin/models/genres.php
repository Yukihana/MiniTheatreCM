...
class MiniTheatreCMModelGenres extends NeonModelList
{
	...
	protected function getListQuery()
	{
		...
		$this->dbselect				= array('a.id', 'a.name', 'a.alias', 'a.access', 'a.state', 'a.publish_up', 'a.publish_down', 'a.author', 'a.recentedit', 'a.created', 'a.modified', 'a.hits', 'a.votes', 'a.rating');
